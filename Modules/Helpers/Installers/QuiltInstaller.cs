...
namespace Qomicex.Core.Modules.Helpers.Installers
{
    public class QuiltInstaller : InstallerBase, IInstaller
    {
        ...
        /// <summary>
        /// 为指定的游戏版本和整合包标识符安装指定版本的 Quilt 模组加载器。
        /// </summary>
        /// <param name="versionId">要安装 Quilt 的整合包或实例的唯一标识符。不能为空。</param>
        /// <param name="inheritsFromJson">继承自版本的JSON内容。可为空，为空时尝试从游戏目录读取。</param>
        /// <param name="quiltVersion">要安装的 Quilt 模组加载器版本。必须是有效的 Quilt 版本字符串。</param>
        /// <param name="gameVersion">Quilt 应安装的游戏版本。必须是受支持的游戏版本。</param>
        /// <param name="installerFilePath">Quilt 安装无需填写此参数，可传入 <see langword="null"/>。</param>
        /// <param name="javaPath">Quilt 安装无需填写此参数，可传入 <see langword="null"/>。</param>
        ...
        /// <param name="quiltVersion">欲安装的Quilt版本</param>
        ...
        public async Task<List<LocalResourceHelper.MissFileData>> GetMissQuiltLibraries(string quiltVersion, string gameVersion, string gameDir)
        {
